...
code = code.replace(/try\s*\{\s*const pluginsDir = path\.join\(__dirname, 'public\/plugins'\);[\s\S]*?\} catch \(error\) \{/, replacement);

fs.writeFileSync('server.js', code, 'utf8');
console.log('Descriptions updated in server.js');
