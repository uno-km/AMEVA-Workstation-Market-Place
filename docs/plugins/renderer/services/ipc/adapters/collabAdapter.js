...
exports.onServerStatus = onServerStatus;
exports.startCollaborationServer = startCollaborationServer;
exports.stopCollaborationServer = stopCollaborationServer;
/*
 * [FUNCTION CONTRACT]
 * - 함수 명: `onServerStatus`
 ...
 */
function onServerStatus(callback) {
    var _a;
    /*
     ...
     */
    if (!((_a = window.electronAPI) === null || _a === void 0 ? void 0 : _a.onServerStatus))
        return () => { };
    return window.electronAPI.onServerStatus(callback);
}
function startCollaborationServer(port) {
    return __awaiter(this, void 0, void 0, function* () {
         ...
         */
        if (!((_a = window.electronAPI) === null || _a === void 0 ? void 0 : _a.startCollaborationServer))
            return null;
...
function stopCollaborationServer() {
    return __awaiter(this, void 0, void 0, function* () {
         ...
         */
        if (!((_a = window.electronAPI) === null || _a === void 0 ? void 0 : _a.stopCollaborationServer))
            return null;
