      ...
      container.innerHTML = `
        <div style="font-family: 'Pretendard', sans-serif; display: flex; flex-direction: column; height: 100%; box-sizing: border-box; gap: 8px;">
          ...
          <div style="font-size: 13px; font-weight: bold; color: #4285F4; display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid #2e2e38; padding-bottom: 6px;">
            <span>🔵 Google Secure Search</span>
          ...
          <div style="font-size: 9.5px; color: var(--text-muted); line-height: 1.4; text-align: center;">
            ※ 임시 보안 파티션 세션이 가동 중입니다. 구글 로그인 및 검색 기록은 앱 종료 시 즉각 소멸합니다.
          </div>

        </div>
      `;

      const webview = container.querySelector('#google-webview');
      if (webview) {
