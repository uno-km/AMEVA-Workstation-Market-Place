document.addEventListener('DOMContentLoaded', () => {
  ...
  {
    "id": "SmartSearchScrap",
    "name": "Smart Search Scrap",
    "description": "<span class='desc-asis'>[As-Is] 일반 브라우저와 검색기를 별도로 띄워 복사 붙여넣기를 반복하는 불편함</span><br/><span class='desc-tobe'>[To-Be] <b>[Premium] 스마트 검색 및 스크랩 (Smart Search & Scrap)!</b> 흔적이 남지 않는 스텔스 구글 엔진 기반 익명 검색과 동시에 원하는 영역만 마크다운으로 발췌합니다.</span><br/><span class='desc-highlight'>💎 프리미엄 특화: 흔적 제로 보안 서칭, Ctrl+F 본문 단어 찾기, 단락별 선택적 스크랩 기능</span>",
    "scriptUrl": "https://uno-km.github.io/AMEVA-Workstation-Market-Place/plugins/premium/SmartSearchScrap.tsx",
    "previewUrl": "https://uno-km.github.io/AMEVA-Workstation-Market-Place/plugins/premium/SmartSearchScrap-preview.html",
    "version": "1.0.0",
    "type": "premium"
  },
  {
