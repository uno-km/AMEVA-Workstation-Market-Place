...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td align="center">
        <img src="https://ui-avatars.com/api/?name=SmartSearchScrap&background=random&color=fff&size=128&font-size=0.4&bold=true" width="65" style="border-radius: 12px; margin-bottom: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/><br/>
        <span style="font-size: 1.5rem;">✨</span>
      </td>
      <td>
        <b style="font-size: 1.1em; color: #2c3e50;">SmartSearchScrap</b><br/><br/>
        <img src="https://img.shields.io/badge/Edition-Enterprise-ff69b4?style=flat-square" />
      </td>
      <td>
        마켓플레이스에 새로 런칭된 최신 확장팩입니다.<br/><br/>
