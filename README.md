...
<table>
  ...
  <tbody>
    <tr>
      <td align="center">
        <img src="https://ui-avatars.com/api/?name=Smart%20Search%20%26%20Scrap&background=random&color=fff&size=128&font-size=0.4&bold=true" width="65" style="border-radius: 12px; margin-bottom: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);"/><br/>
        <span style="font-size: 1.5rem;">🌐</span>
      </td>
      <td>
        <b style="font-size: 1.1em; color: #2c3e50;">Smart Search & Scrap</b><br/><br/>
        <img src="https://img.shields.io/badge/Edition-Enterprise-ff69b4?style=flat-square" />
      </td>
      <td>
        흔적을 남기지 않는 무적의 스텔스 검색 기술(Stealth Google) 및 강력한 단어 찾기(Ctrl+F)를 탑재한 초고속 통합형 검색 및 마크다운 스크랩 플러그인입니다.<br/><br/>
